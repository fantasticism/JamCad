...
typedef struct {
	int m_Width;
	COLORREF m_Color;
}RndHole1FlatAttributes;

class CCadHoleRnd1Flat:public CCadObject
{
	RndHole1FlatAttributes m_Attrb;
public:
	CCadHoleRnd1Flat();
	virtual ~CCadHoleRnd1Flat();
	static void LoadSettings(RndHole1FlatAttributes *pAttrb);
	static void SaveSettings(RndHole1FlatAttributes *pAttrb);
	...
	void CopyAttributes(RndHole1FlatAttributes *pAttrb);

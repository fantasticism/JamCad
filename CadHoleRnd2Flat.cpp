...
void CCadHoleRnd2Flat::LoadSettings(RndHole2FlagAttributes *pAttrib)
{
	/************************************************
	* LoadSetting
...
void CCadHoleRnd2Flat::SaveSettings(RndHole2FlagAttributes *pAttrib)
{
	/************************************************
	* SaveSettings
...
void CCadHoleRnd2Flat::Save(FILE * pO, int Indent, int flags)
{
	//***************************************************
	// Save
...
void CCadHoleRnd2Flat::SetVertex(int v, CPoint p)
{
	//***************************************************
	// SetVertex
...
int CCadHoleRnd2Flat::GrabVertex(CPoint p)
{
	//***************************************************
	// GrabVertex
...
int CCadHoleRnd2Flat::CheckSelected(CPoint p, CSize Offset, CCadObject ** ppSelList , int index, int n, int flag)
{
	//***************************************************
	// CheckSelected
...
void CCadHoleRnd2Flat::AddObject(CCadObject *pO)
{
	//***************************************************
	// AddObject
...
void CCadHoleRnd2Flat::RemoveObject(CCadObject *pO)
{
	//***************************************************
	// RemoveObject
...
CCadObject *CCadHoleRnd2Flat::GetHead(void)
{
	//***************************************************
	// GetHead
...
void CCadHoleRnd2Flat::AdjustRefernce(CPoint Ref)
{
	//***************************************************
	// AdjustRefernce
...
CRect CCadHoleRnd2Flat::GetRect(void)
{
	//***************************************************
	// GetRect
...
char * CCadHoleRnd2Flat::GetTypeString(void)
{
	//***************************************************
	// GetTypeString
...
CCadObject *CCadHoleRnd2Flat::PopHead()
{
	//***************************************************
	// parameters:
	//
...
CCadObject *CCadHoleRnd2Flat::PopTail()
{
	//***************************************************
	// parameters:
	//
...
int CCadHoleRnd2Flat::Parse(int Token, CLexer *pLex)
{
	//***************************************************
	// Parse
...
CCadObject * CCadHoleRnd2Flat::NewInstance()
{
	//***************************************************
	// NewInstance
...
void CCadHoleRnd2Flat::CopyAttributes(RndHole2FlagAttributes *pAttrb)
{
	/***************************************************
	*	CopyAttributes
...
int CCadHoleRnd2Flat::MouseDown(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	//	MouseDown
...
int CCadHoleRnd2Flat::MouseUp(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	// MouseUp
	//		This is the state machine for creating this
...
int CCadHoleRnd2Flat::MouseMove(CAutoScrollView * pASV, int DrawState)
{
	//-------------------------------------------------------
	// MouseMove
	//		This is the state machine for creating this

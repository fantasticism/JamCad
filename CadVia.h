...
class CCadVia :	public CCadObject
{
	ViaAttributes m_Attrb;
public:
	CCadVia();
	virtual ~CCadVia();
	static void LoadSettings(ViaAttributes *pAttrb);
	static void SaveSettings(ViaAttributes *pAttrb);
	...
	void CopyAttributes(ViaAttributes *pAttrb);

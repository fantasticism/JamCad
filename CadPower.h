...
class CCadPower:public CCadObject
{
	PowerAttributes m_Attrb;
public:
	CCadPower();
	virtual ~CCadPower();
	static void LoadSettings(PowerAttributes *pAttrb);
	static void SaveSettings(PowerAttributes *pAttrb);
	...
	CCadPower operator=(CCadPower &v);
	...
	void CopyAttributes(PowerAttributes *pAttrb);

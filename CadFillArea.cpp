...
void CCadFillArea::LoadSettings(FillAreaAttributes *pAttrib)
{
	/************************************************
	* LoadSetting
...
void CCadFillArea::SaveSettings(FillAreaAttributes *pAttrib)
{
	/************************************************
	* SaveSettings
...
void CCadFillArea::Move(CPoint p)
{
	//***************************************************
	//	Move
...
void CCadFillArea::Save(FILE * pO, int Indent, int flags)
{
	//***************************************************
	// Save
...
void CCadFillArea::SetVertex(int v, CPoint p)
{
	//***************************************************
	// SetVertex
...
int CCadFillArea::GrabVertex(CPoint p)
{
	//***************************************************
	// GrabVertex
...
void CCadFillArea::Draw(CDC * pDC, int mode, CPoint Offset, CScale Scale)
{
	//***************************************************
	// Draw
...
int CCadFillArea::CheckSelected(CPoint p, CSize Offset, CCadObject ** ppSelList , int index, int n, int flag)
{
	//***************************************************
	// CheckSelected
...
CPoint CCadFillArea::GetReference()
{
	//***************************************************
	// GetReference
...
void CCadFillArea::AddObject(CCadObject *pO)
{
	//***************************************************
	// AddObject
...
void CCadFillArea::RemoveObject(CCadObject *pO)
{
	//***************************************************
	// RemoveObject
...
CCadObject *CCadFillArea::GetHead(void)
{
	//***************************************************
	// GetHead
...
void CCadFillArea::AdjustRefernce(CPoint Ref)
{
	//***************************************************
	// AdjustRefernce
...
CRect CCadFillArea::GetRect(void)
{
	//***************************************************
	// GetRect
...
char * CCadFillArea::GetTypeString(void)
{
	//***************************************************
	// GetTypeString
	...
	//--------------------------------------------------
	return (char *)"Fill Area";
}

CCadFillArea CCadFillArea::operator=(CCadFillArea &v)
{
	//***************************************************
	// operator=
...
CPoint CCadFillArea::ScalePoint(CPoint p, int Scale, int ScaleDiv)
{
	//***************************************************
	// parameters:
	//
...
CCadObject * CCadFillArea::CopyObject(void)
{
	//***************************************************
	// CopyObject
	...
	//--------------------------------------------------
	CCadFillArea *pFA = new CCadFillArea;
	*pFA = *this;
	return pFA;
}

void CCadFillArea::SetRect(CRect & rect, CPoint P1, CPoint P2, CSize Lw)
{
	//***************************************************
	// parameters:
	//
...
void CCadFillArea::RenderEnable(int e)
{
	//***************************************************
	// RenderEnable
...
CCadObject *CCadFillArea::PopHead()
{
	//***************************************************
	// parameters:
	//
...
CCadObject *CCadFillArea::PopTail()
{
	//***************************************************
	// parameters:
	//
...
void CCadFillArea::ChangeCenter(CSize p)
{
	//***************************************************
	// ChangeCenter
...
void CCadFillArea::ChangeSize(CSize Sz)
{
	//***************************************************
	// ChangeSize
...
int CCadFillArea::Parse(int Token, CLexer *pLex)
{
	//***************************************************
	// Parse
...
CCadObject * CCadFillArea::NewInstance()
{
	//***************************************************
	// NewInstance
...
void CCadFillArea::CopyAttributes(FillAreaAttributes *pAttrb)
{
	/***************************************************
	*	CopyAttributes
...
int CCadFillArea::MouseDown(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	//	MouseDown
...
int CCadFillArea::MouseUp(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	// MouseUp
	//		This is the state machine for creating this
...
int CCadFillArea::MouseMove(CAutoScrollView * pASV, int DrawState)
{
	//-------------------------------------------------------
	// MouseMove
	//		This is the state machine for creating this

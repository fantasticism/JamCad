...
void CCadSheetPin::LoadSettings(SheetPinAttributes *pAttrib)
{
	/************************************************
	* LoadSetting
...
void CCadSheetPin::SaveSettings(SheetPinAttributes *pAttrib)
{
	/************************************************
	* SaveSettings
...
CCadSheetPin::CCadSheetPin():CCadObject(OBJECT_TYPE_SHEETPIN)
{
}


CCadSheetPin::~CCadSheetPin()
{
}

void CCadSheetPin::Move(CPoint p)
{
	//***************************************************
	//	Move
...
void CCadSheetPin::Save(FILE * pO,int Indent, int flags)
{
	//***************************************************
	// Save
...
void CCadSheetPin::SetVertex(int v, CPoint p)
{
	//***************************************************
	// SetVertex
...
int CCadSheetPin::GrabVertex(CPoint p)
{
	//***************************************************
	// GrabVertex
...
void CCadSheetPin::Draw(CDC * pDC, int mode, CPoint Offset, CScale Scale)
{
	//***************************************************
	// Draw
...
int CCadSheetPin::CheckSelected(CPoint p, CSize Offset, CCadObject ** ppSelList , int index, int n, int flag)
{
	//***************************************************
	// CheckSelected
...
CPoint CCadSheetPin::GetReference()
{
	//***************************************************
	// GetReference
...
void CCadSheetPin::AddObject(CCadObject *pO)
{
	//***************************************************
	// AddObject
...
void CCadSheetPin::RemoveObject(CCadObject *pO)
{
	//***************************************************
	// RemoveObject
...
CCadObject *CCadSheetPin::GetHead(void)
{
	//***************************************************
	// GetHead
...
void CCadSheetPin::AdjustRefernce(CPoint Ref)
{
	//***************************************************
	// AdjustRefernce
...
CRect CCadSheetPin::GetRect(void)
{
	//***************************************************
	// GetRect
...
char * CCadSheetPin::GetTypeString(void)
{
	//***************************************************
	// GetTypeString
	...
	//--------------------------------------------------
	return (char *)"Sheet Pin";
}

CCadSheetPin CCadSheetPin::operator=(CCadSheetPin &v)
{
	//***************************************************
	// operator=
...
CPoint CCadSheetPin::ScalePoint(CPoint p, int Scale, int ScaleDiv)
{
	//***************************************************
	// parameters:
	//
...
CCadObject * CCadSheetPin::CopyObject(void)
{
	//***************************************************
	// CopyObject
	...
	//--------------------------------------------------
	CCadSheetPin *pSP = new CCadSheetPin;
	*pSP = *this;
	return pSP;
}

void CCadSheetPin::SetRect(CRect & rect, CPoint P1, CPoint P2, CSize Lw)
{
	//***************************************************
	// parameters:
	//
...
void CCadSheetPin::RenderEnable(int e)
{
	//***************************************************
	// RenderEnable
...
CCadObject *CCadSheetPin::PopHead()
{
	//***************************************************
	// parameters:
	//
...
CCadObject *CCadSheetPin::PopTail()
{
	//***************************************************
	// parameters:
	//
...
void CCadSheetPin::ChangeCenter(CSize p)
{
	//***************************************************
	// ChangeCenter
...
void CCadSheetPin::ChangeSize(CSize Sz)
{
	//***************************************************
	// ChangeSize
...
int CCadSheetPin::Parse(int Token, CLexer *pLex)
{
	//***************************************************
	// Parse
...
CCadObject * CCadSheetPin::NewInstance()
{
	//***************************************************
	// NewInstance
...
void CCadSheetPin::CopyAttributes(SheetPinAttributes *pAttrb)
{
	/***************************************************
	*	CopyAttributes
...
int CCadSheetPin::MouseDown(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	//	MouseDown
...
int CCadSheetPin::MouseUp(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	// MouseUp
	//		This is the state machine for creating this
...
int CCadSheetPin::MouseMove(CAutoScrollView * pASV, int DrawState)
{
	//-------------------------------------------------------
	// MouseMove
	//		This is the state machine for creating this

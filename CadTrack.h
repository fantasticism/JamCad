...
class CCadTrack :public CCadObject
{
	TrackAttributes m_Attrb;
public:
	CCadTrack();
	virtual ~CCadTrack();
	static void LoadSettings(TrackAttributes *pAttrb);
	static void SaveSettings(TrackAttributes *pAttrb);
	...
	CCadTrack operator=(CCadTrack &v);
	...
	void CopyAttributes(TrackAttributes *pAttrb);

...
class CCadSheetPort:public CCadObject
{
	SheetPortAttributes m_Attrb;
public:
	CCadSheetPort();
	virtual ~CCadSheetPort();
	static void LoadSettings(SheetPortAttributes *pAttrb);
	static void SaveSettings(SheetPortAttributes *pAttrb);
	...
	CCadSheetPort operator=(CCadSheetPort &v);
	...
	void CopyAttributes(SheetPortAttributes *pAttrb);

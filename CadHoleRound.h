...
{
	RoundHoleAttributes m_Attrb;
public:
	CCadHoleRound();
	virtual ~CCadHoleRound();
	static void LoadSettings(RoundHoleAttributes *pAttrb);
	static void SaveSettings(RoundHoleAttributes *pAttrb);
	...
	void CopyAttributes(RoundHoleAttributes *pAttrb);

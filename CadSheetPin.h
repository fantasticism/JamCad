...
class CCadSheetPin:public CCadObject
{
	SheetPinAttributes m_Attrb;
public:
	CCadSheetPin();
	virtual ~CCadSheetPin();
	static void LoadSettings(SheetPinAttributes *pAttrb);
	static void SaveSettings(SheetPinAttributes *pAttrb);
	...
	CCadSheetPin operator=(CCadSheetPin &v);
	...
	void CopyAttributes(SheetPinAttributes *pAttrb);

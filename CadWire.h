...
class CCadWire:public CCadObject
{
	WireAttributes m_Attrb;
public:
	CCadWire();
	virtual ~CCadWire();
	static void LoadSettings(WireAttributes *pAttrb);
	static void SaveSettings(WireAttributes *pAttrb);
	...
	void CopyAttributes(WireAttributes *pAttrb);

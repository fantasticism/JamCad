...
void CCadBusEntry::LoadSettings(BusEntryAttributes *pAttrib)
{
	/************************************************
	* LoadSetting
...
void CCadBusEntry::SaveSettings(BusEntryAttributes *pAttrib)
{
	/************************************************
	* SaveSettings
...
CCadBusEntry::CCadBusEntry():CCadObject(OBJECT_TYPE_BUSENTRY)
{
}


CCadBusEntry::~CCadBusEntry()
{
}

void CCadBusEntry::Move(CPoint p)
{
	//***************************************************
	//	Move
...
void CCadBusEntry::Save(FILE * pO, int Indent, int flags)
{
	//***************************************************
	// Save
...
void CCadBusEntry::SetVertex(int v, CPoint p)
{
	//***************************************************
	// SetVertex
...
int CCadBusEntry::GrabVertex(CPoint p, CScale scale)
{
	//***************************************************
	// GrabVertex
...
void CCadBusEntry::Draw(CDC * pDC, int mode, CPoint Offset, CScale Scale)
{
	//***************************************************
	// Draw
...
int CCadBusEntry::CheckSelected(CPoint p, CSize Offset, CCadObject ** ppSelList , int index, int n, int flag)
{
	//***************************************************
	// CheckSelected
...
CPoint CCadBusEntry::GetReference()
{
	//***************************************************
	// GetReference
...
void CCadBusEntry::AddObject(CCadObject *pO)
{
	//***************************************************
	// AddObject
...
void CCadBusEntry::RemoveObject(CCadObject *pO)
{
	//***************************************************
	// RemoveObject
...
CCadObject *CCadBusEntry::GetHead(void)
{
	//***************************************************
	// GetHead
...
void CCadBusEntry::AdjustRefernce(CPoint Ref)
{
	//***************************************************
	// AdjustRefernce
...
CRect CCadBusEntry::GetRect(void)
{
	//***************************************************
	// GetRect
...
char * CCadBusEntry::GetTypeString(void)
{
	//***************************************************
	// GetTypeString
	...
	//--------------------------------------------------
	return (char *)"Bus Entry";
}

CCadBusEntry CCadBusEntry::operator=(CCadBusEntry &v)
{
	//***************************************************
	// operator=
...
CPoint CCadBusEntry::ScalePoint(CPoint p, int Scale, int ScaleDiv)
{
	//***************************************************
	// parameters:
	//
...
CCadObject * CCadBusEntry::CopyObject(void)
{
	//***************************************************
	// CopyObject
	...
	//--------------------------------------------------
	CCadBusEntry *pBE = new CCadBusEntry;
	*pBE = *this;
	return pBE;
}

void CCadBusEntry::SetRect(CRect & rect, CPoint P1, CPoint P2, CSize Lw)
{
	//***************************************************
	// parameters:
	//
...
void CCadBusEntry::RenderEnable(int e)
{
	//***************************************************
	// RenderEnable
...
CCadObject *CCadBusEntry::PopHead()
{
	//***************************************************
	// parameters:
	//
...
CCadObject *CCadBusEntry::PopTail()
{
	//***************************************************
	// parameters:
	//
...
void CCadBusEntry::ChangeCenter(CSize p)
{
	//***************************************************
	// ChangeCenter
...
void CCadBusEntry::ChangeSize(CSize Sz)
{
	//***************************************************
	// ChangeSize
...
int CCadBusEntry::Parse(int Token, CLexer *pLex)
{
	//***************************************************
	// Parse
...
CCadObject * CCadBusEntry::NewInstance()
{
	//***************************************************
	// NewInstance
...
void CCadBusEntry::CopyAttributes(BusEntryAttributes *pAttrb)
{
	/***************************************************
	*	CopyAttributes
...
int CCadBusEntry::MouseDown(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	//	MouseDown
...
int CCadBusEntry::MouseUp(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	// MouseUp
	//		This is the state machine for creating this
...
int CCadBusEntry::MouseMove(CAutoScrollView * pASV, int DrawState)
{
	//-------------------------------------------------------
	// MouseMove
	//		This is the state machine for creating this

...
public:
	CCadFillArea();
	~CCadFillArea();
	static void LoadSettings(FillAreaAttributes *pAttrb);
	static void SaveSettings(FillAreaAttributes *pAttrb);
	...
	CCadFillArea operator=(CCadFillArea &v);
	...
	void CopyAttributes(FillAreaAttributes *pAttrb);

...
{
	OriginAttributes m_Attrb;
public:
	CCadOrigin();
	virtual ~CCadOrigin();
	static void LoadSettings(OriginAttributes *pAttrb);
	static void SaveSettings(OriginAttributes *pAttrb);
	...
	void CopyAttributes(OriginAttributes *pAttrb);

...
class CCadBus:public CCadObject
{
	BusAttributes m_Attrb;
public:
	CCadBus();
	virtual ~CCadBus();
	static void LoadSettings(BusAttributes *pAttrb);
	static void SaveSettings(BusAttributes *pAttrb);
	...
	void CopyAttributes(BusAttributes *pAttrb);

...
void CCadHoleRnd1Flat::LoadSettings(RndHole1FlatAttributes *pAttrib)
{
	/************************************************
	* LoadSetting
...
void CCadHoleRnd1Flat::SaveSettings(RndHole1FlatAttributes *pAttrib)
{
	/************************************************
	* SaveSettings
...
void CCadHoleRnd1Flat::Save(FILE * pO, int Indent, int flags)
{
	//***************************************************
	// Save
...
void CCadHoleRnd1Flat::SetVertex(int v, CPoint p)
{
	//***************************************************
	// SetVertex
...
int CCadHoleRnd1Flat::GrabVertex(CPoint p)
{
	//***************************************************
	// GrabVertex
...
int CCadHoleRnd1Flat::CheckSelected(CPoint p, CSize Offset, CCadObject ** ppSelList , int index, int n, int flag)
{
	//***************************************************
	// CheckSelected
...
void CCadHoleRnd1Flat::AddObject(CCadObject *pO)
{
	//***************************************************
	// AddObject
...
void CCadHoleRnd1Flat::RemoveObject(CCadObject *pO)
{
	//***************************************************
	// RemoveObject
...
CCadObject *CCadHoleRnd1Flat::GetHead(void)
{
	//***************************************************
	// GetHead
...
void CCadHoleRnd1Flat::AdjustRefernce(CPoint Ref)
{
	//***************************************************
	// AdjustRefernce
...
CRect CCadHoleRnd1Flat::GetRect(void)
{
	//***************************************************
	// GetRect
...
char * CCadHoleRnd1Flat::GetTypeString(void)
{
	//***************************************************
	// GetTypeString
...
CPoint CCadHoleRnd1Flat::ScalePoint(CPoint p, int Scale, int ScaleDiv)
{
	//***************************************************
	// parameters:
	//
...
CCadObject *CCadHoleRnd1Flat::PopHead()
{
	//***************************************************
	// parameters:
	//
...
CCadObject *CCadHoleRnd1Flat::PopTail()
{
	//***************************************************
	// parameters:
	//
...
int CCadHoleRnd1Flat::Parse(int Token, CLexer *pLex)
{
	//***************************************************
	// Parse
...
CCadObject * CCadHoleRnd1Flat::NewInstance()
{
	//***************************************************
	// NewInstance
...
void CCadHoleRnd1Flat::CopyAttributes(RndHole1FlatAttributes *pAttrb)
{
	/***************************************************
	*	CopyAttributes
...
int CCadHoleRnd1Flat::MouseDown(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	//	MouseDown
...
int CCadHoleRnd1Flat::MouseUp(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	// MouseUp
	//		This is the state machine for creating this
...
int CCadHoleRnd1Flat::MouseMove(CAutoScrollView * pASV, int DrawState)
{
	//-------------------------------------------------------
	// MouseMove
	//		This is the state machine for creating this

...
{
	RectHoleAttributes m_Attrb;
public:
	CCadHoleRect();
	~CCadHoleRect();
	static void LoadSettings(RectHoleAttributes *pAttrb);
	static void SaveSettings(RectHoleAttributes *pAttrb);
	...
	void CopyAttributes(RectHoleAttributes *pAttrb);

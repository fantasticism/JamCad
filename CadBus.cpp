...
void CCadBus::LoadSettings(BusAttributes *pAttrib)
{
	/************************************************
	* LoadSetting
...
void CCadBus::SaveSettings(BusAttributes *pAttrib)
{
	/************************************************
	* SaveSettings
...
CCadBus::CCadBus():CCadObject(OBJECT_TYPE_BUS)
{
}
...
void CCadBus::Save(FILE * pO, int Indent, int flags)
{
	//***************************************************
	// Save
...
void CCadBus::SetVertex(int v, CPoint p)
{
	//***************************************************
	// SetVertex
...
int CCadBus::GrabVertex(CPoint p, CScale scale)
{
	//***************************************************
	// GrabVertex
...
void CCadBus::Draw(CDC * pDC, int mode, CPoint Offset, CScale Scale)
{
	//***************************************************
	// Draw
...
int CCadBus::CheckSelected(CPoint p, CSize Offset, CCadObject ** ppSelList , int index, int n, int flag)
{
	//***************************************************
	// CheckSelected
...
void CCadBus::AddObject(CCadObject *pO)
{
	//***************************************************
	// AddObject
...
void CCadBus::RemoveObject(CCadObject *pO)
{
	//***************************************************
	// RemoveObject
...
CCadObject *CCadBus::GetHead(void)
{
	//***************************************************
	// GetHead
...
void CCadBus::AdjustRefernce(CPoint Ref)
{
	//***************************************************
	// AdjustRefernce
...
char * CCadBus::GetTypeString(void)
{
	//***************************************************
	// GetTypeString
...
CCadBus CCadBus::operator=(CCadBus &v)
{
	//***************************************************
	// operator=
...
CPoint CCadBus::ScalePoint(CPoint p, int Scale, int ScaleDiv)
{
	//***************************************************
	// parameters:
	//
...
CCadObject * CCadBus::CopyObject(void)
{
	//***************************************************
	// CopyObject
	...
	//--------------------------------------------------
	CCadBus *pBus = new CCadBus;
	*pBus = *this;
	return pBus;
}

void CCadBus::SetRect(CRect & rect, CPoint P1, CPoint P2, CSize Lw)
{
	//***************************************************
	// parameters:
	//
...
void CCadBus::RenderEnable(int e)
{
	//***************************************************
	// RenderEnable
...
void CCadBus::ChangeCenter(CSize p)
{
	//***************************************************
	// ChangeCenter
...
void CCadBus::ChangeSize(CSize Sz)
{
	//***************************************************
	// ChangeSize
...
int CCadBus::Parse(int Token, CLexer *pLex)
{
	//***************************************************
	// Parse
...
CCadObject * CCadBus::NewInstance()
{
	//***************************************************
	// NewInstance
...
void CCadBus::CopyAttributes(BusAttributes *pAttrb)
{
	/***************************************************
	*	CopyAttributes
...
int CCadBus::MouseDown(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	//	MouseDown
...
int CCadBus::MouseUp(CAutoScrollView * pASV, int DrawState, void * pAdrbData)
{
	//-------------------------------------------------------
	// MouseUp
	//		This is the state machine for creating this
...
int CCadBus::MouseMove(CAutoScrollView * pASV, int DrawState)
{
	//-------------------------------------------------------
	// MouseMove
	//		This is the state machine for creating this

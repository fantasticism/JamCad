...
class CCadPad :public CCadObject
{
	PadAttributes m_Attrb;
public:
	CCadPad();
	~CCadPad();
	static void LoadSettings(PadAttributes *pAttrb);
	static void SaveSettings(PadAttributes *pAttrb);
	...
	void CopyAttributes(PadAttributes *pAttrb);
